...
namespace DapperSW.Controllers
{
    public class FilmController : Controller
    {
        ...
        {
            var query = @"Select title, description, cast(release_year as int) as releaseyear, cast(rating as text) as rating
            FROM film
            WHERE film_id = @id;
